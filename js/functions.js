...
function startHeartAnimation(){
	...
	var a=setInterval(function(){
		...
		for(var f=0;f<b.length;f++){
			...
			if(j<Garden.options.bloomRadius.max*1.3){
				e=false;
				break}}
				if(e){b.push(h);garden.createRandomBloom(h[0],h[1])}if(d>=30){clearInterval(a);
					showMessages()}
					else{
						d+=0.2}},c)}
	(function(a){a.fn.typewriter=function(){
		...
		function timeElapse(c){var e=Date();
			...
			$("#words").css("top",$("#garden").position().top+195);$("#words").css("left",$("#garden").position().left+70)}
